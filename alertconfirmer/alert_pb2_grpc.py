...
class AlertSender(object):
    ...
    def SendNotification(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/alert.AlertSender/SendNotification',
...
class AlertConfirmer(object):
    ...
    def confirmAlertReceipt(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/alert.AlertConfirmer/confirmAlertReceipt',
            alert__pb2.ReceiptConfirmation.SerializeToString,
            alert__pb2.Status.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
